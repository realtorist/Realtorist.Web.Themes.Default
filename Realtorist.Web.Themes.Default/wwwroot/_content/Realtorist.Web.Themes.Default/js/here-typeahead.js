(function (Bloodhound) {
    ...
    var Options = /*#__PURE__*/function () {
        ...
        function Options(options) {
            ...
            _defineProperty(this, "url", 'https://autocomplete.search.hereapi.com/v1/autocomplete');
    ...
    var HereAddressEngine = /*#__PURE__*/function (_Bloodhound) {
        _inherits(HereAddressEngine, _Bloodhound);

        var _super = _createSuper(HereAddressEngine);

        function HereAddressEngine(options) {
            var _this;

            var $ = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : window.$;

            _classCallCheck(this, HereAddressEngine);

            options = new Options(options);
            _this = _super.call(this, {
                local: [],
                queryTokenizer: Bloodhound__default['default'].tokenizers.nonword,
                datumTokenizer: HereAddressEngine.datumTokenizer,
                identify: HereAddressEngine.identify,
                remote: {
                    url: options.api,
                    ...
                    transform: function transform(response) {
                        response.items.forEach(function (feature) {
        ...
        _createClass(HereAddressEngine, [{
            key: "search",
            value: function search(query, syncFn, asyncFn) {
                ...
                _get(_getPrototypeOf(HereAddressEngine.prototype), "search", this).call(this, query, function (datums) {
            ...
            value: function datumTokenizer(feature) {
                return Bloodhound__default['default'].tokenizers.obj.whitespace(['countryName', 'city', 'postalCode', 'county', 'state', 'street', 'houseNumber'])(feature.address);
            }
        }, {
            key: "identify",
        ...
        return HereAddressEngine;
    }(Bloodhound__default['default']);

    window.HereAddressEngine = HereAddressEngine;
